    ...
    MassTransitStateMachine<OrderState>
{
        ...
        ILogger<OrderStateMachine> logger)
    {
        ...
        Initially(
            ...
            .Then(x => logger.LogInformation($"OrderStateMachine Order {x.Instance.OrderId} submitted"))
        ...
        During(Submitted,
             ...
             .TransitionTo(Canceled).Finalize());
    ...
    private void ConfigureCorrelationIds()
    {
        ...
        Event(() => StockIsRejectedEvent, x => x.CorrelateById(x => x.Message.OrderNumber));
        Event(() => PaiedEvent, x => x.CorrelateById(x => x.Message.OrderNumber));
    ...
    public Event<PaiedStateIntegrationEvent> PaiedEvent { get; private set; }
