            ...
            if (order != null)
            {
                ...
                if (response.Is(out Response<CheckPaidResponse> responsePaied))
                {
                    if (responsePaied.Message.IsPaid)
                    {
                        ...
                        PaiedSuccessStateIntegrationEvent paiedStateIntegration = new PaiedSuccessStateIntegrationEvent(responsePaied.Message.OrderId, responsePaied.Message.OrderNumber, responsePaied.Message.TransactionId);
