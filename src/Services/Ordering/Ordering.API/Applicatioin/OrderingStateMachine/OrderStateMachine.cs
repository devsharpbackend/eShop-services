    ...
    MassTransitStateMachine<OrderState>
{
        ...
        ILogger<OrderStateMachine> logger)
    {
        ...
        During(Paied,
             When(UpdatedStockConfirmedEvent)
                 ...
                 .TransitionTo(UpdateStockConfirmed)
                 .Finalize(),
            When(UpdatedStockRejectedEvent)
                 ...
                 .TransitionTo(UpdatedStockRejected)
                 .Finalize());
    ...
    private void ConfigureCorrelationIds()
    {
        ...
        Event(() => OrderSubmittedEvent,
            x => {
                 x.CorrelateById(x => x.Message.OrderNumber);
    ...
    public State UpdateStockConfirmed { get; private set; }
    public State UpdatedStockRejected { get; private set; }
