...
public class GrpcServerExceptionInterceptor : Interceptor
{
        ...
        UnaryServerMethod<TRequest, TResponse> continuation)
    {
        ...
        catch (Exception exception)
        {
            ...
            if (exception.GetType() == typeof(OrderingApplicationException))
            {
                var orderApplicationException = exception as OrderingApplicationException;
                httpContext.Response.StatusCode = orderApplicationException.JsonErrorResponse.StatusCode;
                throw new RpcException(new Status(StatusCode.Internal, JsonSerializer.Serialize<JsonErrorResponse>(orderApplicationException.JsonErrorResponse)));
            }
