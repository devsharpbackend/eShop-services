...
{
    public async Task MagirateAndSeedAsync(ConfigurationDbContext context, IConfiguration configuration)
    {
        ...
        clientUrls.Add("webshoppingapigw", configuration.GetValue<string>("webshoppingapigwClient"));
