...
namespace eShop.Services.Basket.BasketAPI.Infrastructure.Filters;
public class HttpGlobalExceptionFilter : IExceptionFilter
{
    ...
    public void OnException(ExceptionContext context)
    {
        ...
        if (context.Exception.GetType() == typeof(BasketApplicationException))
        {
            var catalogApplicationException = context.Exception as BasketApplicationException;
